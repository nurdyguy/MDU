...
namespace EulerService.Contracts
{
    //public interface IEulerService
    //{
    //    object RunProblem(double x, double y = 0, double z = 0);
    //    //object RunProblem207(long max);
    //    //object RunProblem401(int exp);
    //    //object RunProblem432(int num, int exp);
    ...
    //    //object RunProblem576(int pMax, double gapSize, double gapDist);
